...
export declare namespace env {
     ...
     *  @endcode
     */
    function db_get_i64(iterator: i32, data: usize, len: u32): i32;
     ...
     *  @endcode
     */
    function db_next_i64(iterator: i32, primary: usize): i32;
     ...
     *  @endcode
     */
    function db_previous_i64(iterator: i32, primary: usize): i32;
     ...
     *  @post the table row pointed to by `iterator` is removed and the associated storage costs are refunded to the payer
     */
    function db_idx64_remove(iterator: i32): void;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row following the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx64_next(iterator: i32, primary: usize): i32;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row preceding the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx64_previous(iterator: i32, primary: usize): i32;
     ...
     *  @post the table row pointed to by `iterator` is removed and the associated storage costs are refunded to the payer
     */
    function db_idx128_remove(iterator: i32): void;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row following the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx128_next(iterator: i32, primary: usize): i32;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row preceding the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx128_previous(iterator: i32, primary: usize): i32;
     ...
     *  @post the table row pointed to by `iterator` is removed and the associated storage costs are refunded to the payer
     */
    function db_idx256_remove(iterator: i32): void;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row following the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx256_next(iterator: i32, primary: usize): i32;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row preceding the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx256_previous(iterator: i32, primary: usize): i32;
     ...
     *  @post the table row pointed to by `iterator` is removed and the associated storage costs are refunded to the payer
     */
    function db_idx_double_remove(iterator: i32): void;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row following the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx_double_next(iterator: i32, primary: usize): i32;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row preceding the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx_double_previous(iterator: i32, primary: usize): i32;
     ...
     *  @post the table row pointed to by `iterator` is removed and the associated storage costs are refunded to the payer
     */
    function db_idx_long_double_remove(iterator: i32): void;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row following the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx_long_double_next(iterator: i32, primary: usize): i32;
     ...
     *  @post `*primary` will be replaced with the primary key of the table row preceding the referenced table row if it exists, otherwise `*primary` will be left untouched
     */
    function db_idx_long_double_previous(iterator: i32, primary: usize): i32;
